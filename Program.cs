using System;
using ContaFiado.Model;

namespace ContaFiado    
{
    class Program
    {
        static void Main()

        {
            ...
            Console.WriteLine("2 - Cadastro de Mercadoria");
            Console.WriteLine("3 - Conta Fiado");
            ...
            //        Clientes pess01 = new Clientes { Id = Guid.NewGuid().ToString() };
